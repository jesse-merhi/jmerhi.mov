    ...
    for (let l = e.claim_info.last_index - 1; l >= 0; l--) {
      ...
      if (t(f)) {
        ...
        return (
          i === void 0 ? e.splice(l, 1) : (e[l] = i),
          s
            ? i === void 0 && e.claim_info.last_index--
...
function K(e, t, n) {
  ...
  a && a.m(t, n),
    b(() => {
      const c = e.$$.on_mount.map(T).filter(S);
...
function X(e, t) {
  e.$$.dirty[0] === -1 && (q.push(e), H(), e.$$.dirty.fill(0)),
    (e.$$.dirty[(t / 31) | 0] |= 1 << t % 31);
}
function $e(e, t, n, a, s, c, l = null, f = [-1]) {
  const i = P;
  N(e);
  const r = (e.$$ = {
    fragment: null,
  ...
  if (
    ((r.ctx = n
      ? n(e, t.props || {}, (u, _, ...g) => {
          const v = g.length ? g[0] : _;
          return (
            r.ctx &&
              s(r.ctx[u], (r.ctx[u] = v)) &&
              (!r.skip_bound && r.bound[u] && r.bound[u](v), o && X(e, u)),
            _
          );
        })
      : []),
    ...
    t.intro && J(e.$$.fragment), K(e, t.target, t.anchor), O(), C();
  }
  N(i);
}
class pe {
